...
def run(
        ...
        source=ROOT / 'image_12.jpg',  # file/dir/URL/glob, 0 for webcam
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_crop:
                        ...
                        # print(names[c], result)
                        final_ocr = names[c] + ': ' + result
                        ocr_result.append(final_ocr)
